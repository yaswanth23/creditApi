...
public class ErrorConstants {
    ...
    public static final String ERROR_STATUS_CODE_201 = "201";
    public static final String CUST_ID_EXISTS_ERROR_STATUS_CODE_201_MESSAGE = "Customer id already exists";
